...
# INPUTS=====
proj.file="D:/GG_Jambi/process/lumens_dir/trial/bau_Jambi/bau_Jambi.lpj"
landuse_1="lc_bau_1990"
landuse_2="lc_bau_2000"
planning_unit="pu_ver1"
raster.nodata= 0
include_peat= 1
peatmap= "pu_ver1"
# peat_cell=1 # id of designated pu_ver1 which are considered as peat
...
peatcell <- pt_table[grep("Gambut", pt_table$Legend), "ID"] #ADedit 01/09/2018
