...
# 0. INPUTS====
working_directory= "E:/GG_Jambi/process/lumens_dir/trial"
raster_directory= "E:/GG_Jambi/General/data/spatial/raster"
table_directory = "E:/GG_Jambi/General/data/table"
description= "GGP"
province= "Jambi"
country= "Indonesia"
admin_attribute= readOGR(dsn = "E:/GG_Jambi/General/data/spatial/vector", layer = "admin_diss") # ADedit
field_attribute= "IDADM" # ADedit
spat_res= 100
dissolve_table = "E:/GG_Jambi/General/data/table/kab_diss.csv"

# 0.5 EXTRA INPUT VARIABLES====
scenarios <- c("bau", "bauAlt", "bauPlan", "ggp", "exp", "tes") #ADedit
...
attribute_table= "E:/GG_Jambi/General/data/table/pu_lookup.csv" # attribute table location which has columns c("ID", "COUNT", "Legend")
#statusoutput=output table
#passfilenames
